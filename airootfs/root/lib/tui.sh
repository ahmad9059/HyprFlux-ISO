...
# Logo / branding
LOGO_COLOR="\033[1;36m" # Bold cyan
...
show_banner() {
  ...
  # Add spacing from top of terminal
  echo ""
...
BANNER
  ...
  # Add separator and welcome message (centered with same padding as banner)
  echo -e "${padding}${RED}✻────────────────────────────ahmad9059────────────────────────────✻${RESET}"
  echo -e "${padding}${GREEN}          Welcome to HyprFlux! lets begin Installation${RESET}"
